...
public class RedRecordSqlProvider {

    public String countByExample(RedRecordExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("red_record");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(RedRecordExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("red_record");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(RedRecord record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("red_record");
    ...
    public String selectByExample(RedRecordExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        RedRecord record = (RedRecord) parameter.get("record");
        RedRecordExample example = (RedRecordExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("red_record");
    ...
    public String updateByPrimaryKeySelective(RedRecord record) {
        SQL sql = new SQL();
        sql.UPDATE("red_record");
    ...
    protected void applyWhere(SQL sql, RedRecordExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
